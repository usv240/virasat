...
npm test              # 47 tests: rule engine, AIS parser, claim pack, dividends, cost model, corpus
...
| Cost of serving one family | About ₹33 of AI, measured from real token counts at published prices on 21 Sep 2026, against an average of ₹38,700 returned per family at Gujarat's camps. Shown in full on [/proof](https://virasat-indol.vercel.app/proof), reproducible with `npm run measure:cost`. |
