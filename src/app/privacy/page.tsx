  ...
  return (
    <Section eyebrow="Privacy" title="Your data, in plain words">
      <div className="max-w-3xl space-y-4">
        ...
        <p><strong>Law.</strong> We follow the principles of India&apos;s Digital Personal Data Protection Act 2023: consent, purpose limitation, minimal data, and the right to delete.</p>
