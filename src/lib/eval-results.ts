...
export const EVAL_RESULTS = {
  ...
  rows: [
    ...
    { test: "Accessibility (axe, WCAG 2.2 AA)", cases: "10 pages, light and dark", result: "0 serious or critical", note: "Also zero moderate issues. Re-run with the audit script in the repository." },
    { test: "Lighthouse, desktop, landing page", cases: "4 categories", result: "99 / 100 / 100 / 100", note: "Performance, accessibility, best practices, SEO." },
