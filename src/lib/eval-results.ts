...
export const EVAL_RESULTS = {
  ...
  rows: [
    ...
    { test: "Lighthouse, landing page, live deployment", cases: "2 profiles, 3 runs each", result: "Desktop 99 to 100, mobile 91 to 96", note: "Performance. Accessibility, best practices and SEO are 100 on both. Layout shift is 0 to 0.024 depending on whether the webfont reflows the hero before the stat card below it paints, against a 0.1 threshold. Mobile is Lighthouse's throttled phone, which is closer to the families this is for, so the lower number is the one that matters. Reproduce with npm run audit." },
