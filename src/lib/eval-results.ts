...
export const EVAL_RESULTS = {
  ...
  rows: [
    ...
    { test: "Lighthouse, landing page, live deployment", cases: "2 profiles, 3 runs each", result: "Desktop 99 to 100, mobile 91 to 92", note: "Performance. Accessibility, best practices and SEO are 100 on both, and there is no layout shift. Mobile is Lighthouse's throttled phone, which is closer to the families this is for, so the lower number is the one that matters. Reproduce with npm run audit." },
